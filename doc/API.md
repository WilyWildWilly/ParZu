...
The main app is [parse](./parse?text=Ich%20bin%20ein%20Berliner), which supports POST and GET requests.
...
- format: the desired output format. Default: conll format. Suggested choices:
   - [conll](./parse?text=Ich%20bin%20ein%20Berliner.&format=conll)
   - [prolog](./parse?text=Ich%20bin%20ein%20Berliner.&format=prolog)
